...
@Love2.on_edited_message(
    filters.command(["eval", "Love2"])
...
async def executor(client: Love2, message: Message):
...
@Love2.on_callback_query(filters.regex(r"runtime"))
async def runtime_func_cq(_, cq):
    runtime = cq.data.split(None, 1)[1]
    await cq.answer(runtime, show_alert=True)


@Love2.on_callback_query(filters.regex("forceclose"))
