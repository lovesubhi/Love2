...
from Love2.Helper.requirements import get_audio_stream
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    font1 = ImageFont.truetype(r'Love2/Helper/resources/Love2.otf', 30)
    font2 = ImageFont.truetype(r'Love2/Helper/resources/Love2.otf', 60)
    font3 = ImageFont.truetype(r'Love2/Helper/resources/Love2.otf', 49)
...
@Love2.on_message(filters.command(["play"], prefixes=["/","."]))
...
@Love2.on_message(filters.command(["skip", "next"], prefixes=["/", "!"]) & admin_filter)
...
@Love2.on_message(filters.command("join"))
async def join_userbot(_,msg):
  chat_id = msg.chat.id
  invitelink = await Love2.export_chat_invite_link(chat_id)
...
@Love2.on_message(filters.command(["pause"], prefixes=["/", "!"]))    
...
@Love2.on_message(filters.command(["resume"], prefixes=["/", "!"]))    
...
@Love2.on_message(filters.command(["end"], prefixes=["/", "!"]))    
...
@Love2.on_message(filters.command(["leavevc"], prefixes=["/", "!"]))    
...
@Love2.on_message(filters.command("volume", prefixes="/"))
