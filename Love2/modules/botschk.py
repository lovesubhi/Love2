...
from Love2 import Love2, userbot
from config import SUDO_USERS

BOT_LIST = ["love_subhibot", "miss_subhibot" , "subhi_stringbot"]



@Love2.on_message(filters.command("botschk") & filters.user(SUDO_USERS))
async def bots_chk(Love2, message):
